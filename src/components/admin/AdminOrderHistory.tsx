...
const AdminOrderHistory = () => {
  ...
  const exportToExcel = () => {
    ...
    const titleRows = [
      ...
      [`Date Range: ${filteredOrders.length > 0 ? format(new Date(filteredOrders[0].order_date), 'PP') + ' to ' + format(new Date(filteredOrders[filteredOrders.length-1].order_date), 'PP') : 'N/A'}`],
