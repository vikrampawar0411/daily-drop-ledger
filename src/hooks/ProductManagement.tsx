  ...
  const [showEditDialog, setShowEditDialog] = useState(false);
      <Tabs defaultValue="products">
        ...
        <TabsContent value="products" className="space-y-4">
          ...
          {/* --- Edit Requests section (merged) --- */}
          <div className="pt-6">
            <h3 className="text-lg font-semibold mb-3">Product Changes Requested ({editRequests.filter(r => r.status === 'pending').length})</h3>
          ...
          {/* --- Product Requests section (merged) --- */}
          <div className="pt-6">
            <h3 className="text-lg font-semibold mb-3">New Product Requests ({productRequests.filter(r => r.status === 'pending').length})</h3>
