-- Secure ORDERS table - remove public access and implement role-based security
...
-- Secure DAILY_DELIVERIES table - remove public access and implement role-based security
DROP POLICY IF EXISTS "Allow public delete access to daily_deliveries" ON public.daily_deliveries;
DROP POLICY IF EXISTS "Allow public insert access to daily_deliveries" ON public.daily_deliveries;
DROP POLICY IF EXISTS "Allow public read access to daily_deliveries" ON public.daily_deliveries;
DROP POLICY IF EXISTS "Allow public update access to daily_deliveries" ON public.daily_deliveries;
